...
tags:
  - java
  - JVM
describe: 内容自来尚硅谷宋红康老师的B站视频、youthlql
categories: JVM
cover: 'https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/images/cover7.jpg'
abbrlink: 19878
date: 2022-04-15 08:42:55
---
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0001%20%281%29.png)
...
<img src="https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0002.png" alt="jvm" style="zoom:67%;" />
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0003.png)
...
> 官网地址: https://docs.oracle.com/en/java/javase/11/tools/java.html#GUID-3B1CE181-CD30-4178-9602-230B800D4FAE
...
设置参数方法：run-->Edit Configurations-下图。如果没有vm option选项可以在Modify option中勾选出来

<img src="https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0004.png" alt="jvm" style="zoom:50%;" />
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0005.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0006.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0007.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0008.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0009.png)



2、方法异常信息表

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0010.png)



3、Misc

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0011.png)

4、行号表

Java代码的行号和字节码指令行号的对应关系

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0012.png)

5、注意：生效行数和剩余有效行数都是针对于字节码文件的行数



![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0013.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0014.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0015.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0016.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0017.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0018.png)

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0019.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0020.jpeg)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0021.png)

### 5.1流程

1、首先执行第一条语句，PC寄存器指向的是0，也就是指令地址为0，然后使用bipush让操作数15入操作数栈。

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0022.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0023.png)

3、然后PC下移，指向的是下一行。让操作数8也入栈，同时执行store操作，存入局部变量表中

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0024.png)

4、然后从局部变量表中，依次将数据放在操作数栈中，等待执行 add 操作

iload_1：取出局部变量表中索引为1的数据入操作数栈

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0025.png)

5、然后将操作数栈中的两个元素执行相加操作，并存储在局部变量表3的位置

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0026.png)

### 5.2小问题

**关于类型转换的说明**

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0027.png)

- 因为 8 可以存放在 byte 类型中，所以压入操作数栈的类型为 byte ，而不是 int ，所以执行的字节码指令为 bipush 8
- 但是存储在局部变量的时候，会转成 int 类型的变量：istore_4

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0028.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0029.png)

testGetSum() 方法字节码指令：一上来就加载 getSum() 方法的返回值()

![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0030.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0031.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0032.png)



#### 3关于 invokedynamic 指令
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0033.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0034.png)
...
<img src="https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0035.png" alt="jvm" style="zoom: 50%;" />



<img src="https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0036.jpeg" alt="jvm" style="zoom:75%;" />





<img src="https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0037.jpeg" alt="jvm" style="zoom:75%;" />





<img src="https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0038.jpeg" alt="jvm" style="zoom:75%;" />
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0039.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0040.png)
...
![jvm](https://blog-chy-lua.oss-cn-shanghai.aliyuncs.com/java/jvm04/0041.png)
